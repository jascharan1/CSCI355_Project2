  ...
  <body>
    ...
    <header>
      <nav class="minimal-nav">
        <ul class="navbar">
          ...
          <li><a href="fqa" class="nav-link"> FAQ</a>
          <li><a href="logout" class="nav-link"> LogOut</a>
        </ul>

        <h5>Jascharan Singh -- Harpreet Singh -- Inderpreet Singh</h5>
      </nav>
    ...
    <main>
      <section class="hero-section">
        <h2>Welcome to the Wine & Liquor Store!</h2>
        <p>Discover a wide range of wines and liquors.</p>
        <a href="products">
      ...
      <section class="carousel">
        <h3>Our Featured Wines</h3>
        <div class="carousel-grid">
          <img src="https://www.stettyncellar.co.za/wp-content/uploads/2024/01/promo-21.png" alt="Wine 1">
          <img src="https://www.stettyncellar.co.za/wp-content/uploads/2024/01/promo-21.png" alt="Wine 2">
          <img src="https://www.stettyncellar.co.za/wp-content/uploads/2024/01/promo-21.png" alt="Wine 3">
        </div>
      </section>
      ...
      <section class="inventory">
        ...
        <div class="inventory-grid">
          <div class="inventory-item">
            <a href="wine"><img src="https://www.stettyncellar.co.za/wp-content/uploads/2024/01/promo-21.png"
                alt="Wine"></a>
            <p>Wines</p>
          </div>
          <div class="inventory-item">
    ...
    <div class="body-container">
      <div class="container">
        <div class="split left">
          <a href="wine" class="btn2">Exclusive</a>
        </div>
        <div class="split right">
          <a href="Whiskey" class="btn2">Imported</a>
        </div>
      </div>
    </div>
    <footer>
